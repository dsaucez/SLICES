  ...
  content = templatefile("templates/inventory.tmpl",
    {
     ...
     internal_ip_compute = google_compute_instance.compute[*].network_interface.0.network_ip
     ...
     internal_ip_master = google_compute_instance.master[*].network_interface.0.network_ip
     ...
     internal_ip_switch = google_compute_instance.switch[*].network_interface.0.network_ip
     ...
     internal_ip_openvpn = google_compute_instance.openvpn[*].network_interface.0.network_ip
    }
  )
  filename = "inventory"
}