...
class SopNodeTopo(Topo):
    """1x2 fabric topology with IPv4 hosts"""
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Switch Links
        self.addLink(spine1, leaf1)     # device:spine1/1 <> device:leaf1/1
        self.addLink(spine1, leaf2)     # device:spine1/2 <> device:leaf2/1
        ...
        self.addLink(h1a, leaf1)    # <> leaf1/2
        self.addLink(h1b, leaf1)    # <> leaf1/3
        self.addLink(h1c, leaf1)    # <> leaf1/4
        self.addLink(h2, leaf1)     # <> leaf1/5
        ...
        self.addLink(h3, leaf2)     # <> leaf2/2
        self.addLink(h4, leaf2)     # <> leaf2/3


def main():
    net = Mininet(topo=SopNodeTopo(), controller=None)
    net.start()
    CLI(net)
    net.stop()
    print '#' * 80
